        ...
        <main className="flex-1 w-full max-w-3xl mx-auto px-8 py-10">
            ...
            <div className="mb-10 flex items-start justify-between gap-4">
                ...
                <form action="/auth/signout" method="POST">
                    <button
                        type="submit"
                        className="flex items-center gap-2 px-4 py-2.5 bg-red-50 text-red-600 hover:bg-red-100 text-xs font-bold rounded-xl transition-colors border border-red-200 cursor-pointer shrink-0"
                    >
